...
exports.isWebPSupported = undefined;
...
var LazyImage = function (_Component) {
  ...
  function LazyImage() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = LazyImage.__proto__ || Object.getPrototypeOf(LazyImage)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      if (prevProps.path !== _this.props.path) {
        _this.setSizes();
      ...
      return _react2.default.createElement('img', _extends({
        ...
        src: _this.state.path === '' ? placeholder : _this.state.path + '-' + _this.state.width + '-placeholder.png',
        style: _this.props.style,
        'data-lazy': true,
        'data-src': _this.state.path + '-' + _this.state.width,
        alt: _this.props.alt,
        ref: _this.getRef
      }, _this.props));
